...
public class Magia extends Ataque {
    ...
    public Magia(String nome, String msgUso, int danoBase, String elemento, int custoMp) {
        super(nome, false, msgUso, danoBase); // inicia desabilitada (ate achar scroll)
    ...
    public int danoCausado(Inimigo inimigo) {
        ...
        if (multiplicador != 0.) { // retorno padrao da funcao quando nao encontra o elemento
            // TODO - roubei do lol -- https://leagueoflegends.fandom.com/wiki/Magic_resistance?so=search
